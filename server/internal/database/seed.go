...
func Seed(db *gorm.DB) error {
	...
	banners := []models.Banner{
		...
		{ID: uuid.NewString(), Title: "Immersive Monitors", Subtitle: "4K & QD-OLED Gaming Monitors from StarTech", Image: "https://placehold.co/1400x500/052e16/ef4a23?text=Gaming+Monitors", Link: "/category/monitor", SortOrder: 2, Active: true},
	}
	...
	coupons := []models.Coupon{
		{ID: uuid.NewString(), Code: "STAR10", Type: models.CouponPercent, Value: 10, MinOrder: 10000, MaxUses: 100, Active: true},
